...
Do not fully focus on decreasing elapsedtime, one of the wasting time in yourlife,

There are multiple and various reasons in elapsedtime, and you can't manage everything,

and make sure cheking elapsed time in release mode
